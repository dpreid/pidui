    ...
    <div class='d-flex'>
        <ul class="navbar-nav dropstart">
            ...
            <button type='button' class='btn btn-primary dropdown-toggle' id='prompts-button' data-bs-toggle="dropdown" data-bs-auto-close="false" aria-expanded="false" @click='setPromptUpdate(false)'>
                ...
                <span v-if='getPromptUpdated' class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" z-index='1' id='prompt-notification' role="status" aria-hidden="false">{{ messageCount }}<span class="visually-hidden">unread messages</span></span>
            </button>
