<template>
    <li class="nav-item dropdown">
        <button type='button' class='btn btn-primary dropdown-toggle' id='achievements-button' data-bs-toggle="dropdown" aria-expanded="false" @click='setAchievementUpdate(false)'>
            ...
            <span v-if='getAchievementUpdated' class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" id='achievement-notification' role="status" aria-hidden="true"></span>
        </button>
