<template>
    <li class="nav-item dropdown">
        <button type='button' class='btn btn-primary dropdown-toggle' id='achievements-button' data-bs-toggle="dropdown" aria-expanded="false" @click='setAchievementUpdate(false)'>
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" :fill="getFillColour" class="bi bi-award" viewBox="0 0 16 16">
        ...
        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDropdown2">
            ...
            <div class='d-flex row m-3 justify-items-center'>
                <div class='col-1'>
                    <p>50%+</p>
                </div>
                <div class='col-3'>
